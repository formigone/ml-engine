...
def model_fn(features, labels, mode, params):
    x = tf.reshape(features, [-1, 99, 161, 1], name='input_incep10v7')
    ...
    dropout = tf.layers.dropout(conv1, rate=0.2, training=mode == tf.estimator.ModeKeys.TRAIN, name='dropout1')
    conv1b = tf.layers.conv2d(dropout, filters=16, kernel_size=3, activation=tf.nn.relu, name='conv1b')
    ...
    dropout = tf.layers.dropout(conv3, rate=0.3, training=mode == tf.estimator.ModeKeys.TRAIN, name='dropout3')
    conv3b = tf.layers.conv2d(dropout, filters=32, kernel_size=3, activation=tf.nn.relu, name='conv3b')
    ...
    dropout = tf.layers.dropout(conv5, rate=0.4, training=mode == tf.estimator.ModeKeys.TRAIN, name='dropout5')
    conv5b = tf.layers.conv2d(dropout, filters=64, kernel_size=3, activation=tf.nn.relu, name='conv5b')
    ...
    dropout = tf.layers.dropout(conv7, rate=0.5, training=mode == tf.estimator.ModeKeys.TRAIN, name='dropout7')
    conv7b = tf.layers.conv2d(dropout, filters=128, kernel_size=3, activation=tf.nn.relu, name='conv7b')
