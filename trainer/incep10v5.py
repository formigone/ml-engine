...
def model_fn(features, labels, mode, params):
    x = tf.reshape(features, [-1, 99, 161, 1], name='input_incep10v5')
    ...
    incep2 = inception_block_v2(pool1, t1x1=8, t3x3=8, t5x5=8, tmp=8, name='incep2', norm=True, mode=mode)
    ...
    incep4 = inception_block_v2(pool3, t1x1=8, t3x3=8, t5x5=8, tmp=8, name='incep4', norm=True, mode=mode)
    ...
    incep6 = inception_block_v2(pool5, t1x1=32, t3x3=32, t5x5=32, tmp=32, name='incep6', norm=True, mode=mode)
    ...
    incep8 = inception_block_v2(pool7, t1x1=64, t3x3=64, t5x5=64, tmp=64, name='incep8', norm=True, mode=mode)
    incep9 = inception_block_v2(incep8, t1x1=72, t3x3=72, t5x5=72, tmp=72, name='incep9', norm=True, mode=mode)
    incep10 = inception_block_v2(incep9, t1x1=128, t3x3=128, t5x5=128, tmp=128, name='incep10', norm=True, mode=mode)
    incep11 = inception_block_v2(incep10, t1x1=144, t3x3=144, t5x5=144, tmp=144, name='incep11', norm=True, mode=mode)
    incep12 = inception_block_v2(incep11, t1x1=256, t3x3=256, t5x5=256, tmp=256, name='incep12', norm=True, mode=mode)
    incep13 = inception_block_v2(incep12, t1x1=320, t3x3=320, t5x5=320, tmp=320, name='incep13', norm=True, mode=mode)
    incep14 = inception_block_v2(incep13, t1x1=512, t3x3=512, t5x5=512, tmp=512, name='incep14', norm=True, mode=mode)
